...
import { ProjectScriptCommandPicker } from "./ProjectScriptCommandPicker";
import { guessDetectedScriptIcon } from "./projectScriptCommandPicker.logic";
import {
  AlertDialog,
  AlertDialogClose,
...
const NO_DETECTED_SCRIPTS: ReadonlyArray<DetectedProjectScript> = [];
...
export function ProjectScriptEditorDialog({
  request,
  scripts,
  detectedScripts = NO_DETECTED_SCRIPTS,
  onSubmit,
  onDelete,
  onClose,
}: {
  ...
  /** Scripts found in package.json/composer.json, offered on the Command field. */
