...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.gitGetChangeRequestPipeline]: AuthOrchestrationReadScope,
  [WS_METHODS.gitListChangeRequestThreads]: AuthOrchestrationReadScope,
  [WS_METHODS.gitMergeChangeRequest]: AuthSourceControlWriteScope,
  [WS_METHODS.subscribeChangeRequestStatus]: AuthOrchestrationReadScope,
